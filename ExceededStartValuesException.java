...
public class ExceededStartValuesException extends Exception {
    ...
    /**
     * This constructor calls the super keyword to inform the user when more than two
     * values exist on the first line of a file
     * 
     * @param errorMessage takes an empty string, but will be formatted into a useful message when this exception is thrown
